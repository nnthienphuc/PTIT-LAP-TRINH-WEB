	...
	<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
		<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
			...
			<div class="panel-body">
				${message}
				<form:form action="/admin/product/index" modelAttribute="model" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="form-group col-sm-4">
							...
							<form:select path="category.id" cssClass="form-control" items="${categories}" itemValue="id"
								itemLabel="nameVN" />
						</div>
						<div class="form-group col-sm-4">
							<label>Supplier</label>
							<form:select path="supplier.id" cssClass="form-control" items="${suppliers}" itemValue="id"
								itemLabel="name" />
						</div>
					</div>
