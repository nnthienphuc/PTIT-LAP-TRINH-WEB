...
public class AccountController {
	...
	public String login(Model model, @RequestParam("id") @NotEmpty(message = "Username is required!") String id,
			@RequestParam("pw") @NotEmpty(message = "Password is required!") String pw,
	...
	public String register(Model model, @Validated @ModelAttribute("form") Customer user, BindingResult errors,
		...
		if (errors.hasErrors()) {
			...
			dao.create(user);
			model.addAttribute("message", "Register successfully, check mail to active account!");

			String from = "laptrinhweb.contact@gmail.com";
		...
		return "user/account/ressuccess";
	}
