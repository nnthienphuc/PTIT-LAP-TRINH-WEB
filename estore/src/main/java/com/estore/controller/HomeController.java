...
public class HomeController {
	...
	public String feedback(ModelMap model, @RequestParam("name") String name, @RequestParam("email") String email,
		...
		try {
			...
			helper.setTo("laptrinhweb.contact@gmail.com");
			helper.setReplyTo("Online Shopping Mall <laptrinhweb.contact@gmail.com>");
			...
			model.addAttribute("message",
					"Feedback sent successfully. Thank you for your comments on Online Shopping Mall.");
		} catch (Exception ex) {
			model.addAttribute("message", "An error occurred while sending a response email!");
		}
		return "user/home/feedback";
	}
